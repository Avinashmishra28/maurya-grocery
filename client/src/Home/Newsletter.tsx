...
const Newsletter = () => {
  return (
    <section className="bg-white py-18 px-4 lg:px-8 rounded-3xl mx-auto
       shadow-xs mt-32 mb-20">
        <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-app-text-light mb-8 text-base">
                Get Weekly updates on fresh produce, seasonal offers, and exclusive discounts right to you inbox.
            </p>
