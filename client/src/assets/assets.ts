...
export const heroSectionData = {
  ...
  hero_image: hero_bg,
  hero_features: [
    { icon: TruckIcon, title: "Free Delivery", desc: "Orders over 299" },
...
export const footerData = {
  ...
  contact: [
    { icon: MapPinIcon, text: "273001 station Rd, Gorakhpur" },
    { icon: PhoneIcon, text: " 1234567890" },
    { icon: MailIcon, text: "mauryagrocery@.com" },
  ],

  bottom: {
    copyright: "© 2026 MauryaGrocery. All rights reserved.",
    links: [
